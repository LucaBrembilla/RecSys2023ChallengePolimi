...
class Compute_Similarity_Python:
    ...
    def applyAdjustedCosine(self):
        ...
        self.dataMatrix = self.dataMatrix.tocsr().astype(np.float32)
    ...
    def applyPearsonCorrelation(self):
        ...
        self.dataMatrix = self.dataMatrix.tocsc().astype(np.float32)
        ...
        while start_col_block < end_col_local:
            ...
            for col_index_in_block in range(this_block_size):
                ...
                similarity_builder.add_data_lists(row_list_to_add=relevant_items_partition,
                                                  col_list_to_add=np.ones(len(relevant_items_partition), dtype = np.int64) * columnIndex,
